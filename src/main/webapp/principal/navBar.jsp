			...
			<ul class="nav-right">
					...
					<ul class="show-notification">
						...
						<li class="waves-effect waves-light">
							<div class="media">
								...
								<c:if test="${imagemUser == '' || imagemUser == null}">
									<img src="./assets/images/imagensMinha/usuarioSemFoto.jpg"
										class="img-radius">
								</c:if>
				...
				<li class="user-profile header-notification"><a href="#!"
					class="waves-effect waves-light"> <c:if
							...
							<img src="./assets/images/imagensMinha/usuarioSemFoto.jpg"
								class="img-radius">
						</c:if> <span><%=request.getSession().getAttribute("usuario")%></span>
					...
					<ul class="show-notification profile-notification">
						<!-- 
									...
									-->
						<li class="waves-effect waves-light"><a
							href="<%=request.getContextPath()%>/ServletLoginn?acao=logout">
